...
async def cmd_start(message: types.Message):
    ...
    text = (
        ...
        "Я — ML-ассистент для геймдевов и инвесторов. Моя нейросеть проанализировала тысячи игр в Steam и знает, какие идеи "
        "выстрелят, а какие приведут к провалу.\n\n"
        "Жми кнопку ниже, чтобы оценить свою идею 👇"
    )
